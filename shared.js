...
const Personal = {
  get: function () {
    return {
      first: this.first.get(),
      last: this.last.get(),
      city: this.city.get(),
    }
  },
  set: function (personal) {
    if (!personal || typeof personal !== 'object') {
      throw new Error('Invalid personal data object');
    }
    this.first.set(personal.first);
    this.last.set(personal.last);
    this.city.set(personal.city);
  },
  first: {
    get: function () {
...
const Contact = {
  get: function () {
    return {
      ...
      linkedin: this.linkedin.get(),
      github: this.github.get(),
    }
  },
  set: function (contact) {
    if (!contact || typeof contact !== 'object') {
      throw new Error('Invalid contact data object');
    }
    this.email.set(contact.email);
    this.linkedin.set(contact.linkedin);
    this.github.set(contact.github);
  },
  email: {
    get: function () {
  ...
  linkedin: {
    ...
    set: function (linkedin) {
      ...
      if (!linkedin.trim().toLowerCase().includes('linkedin.com/')) {
  ...
  github: {
    ...
    set: function (github) {
      ...
      if (!github.trim().toLowerCase().includes('github.com/')) {
