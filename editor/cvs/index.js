 ...
 * {
    ...
    "education": [
        {
            "id": "1746010231771",
            "description": "Specialization: Qualitative Studies and Workplace Studies/Ethnomethodology"
        },
        {
            "id": "1746116265467",
            "description": "a"
...
const CV = {
    ...
    save: function (cv, id) {
        localStorage.setItem("cv." + id, JSON.stringify(cv));
    },

    update: function (cv, id) {
        const current = this.load(id) || {}; 
        
        const updated = { ...current, ...cv };
        this.save(updated);
    },
